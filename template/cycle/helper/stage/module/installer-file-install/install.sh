...
################################################################################
### Head: Model / mod_module_installer_file_install
##

sys_module_installer_file_install_verbose () {

	local source_dir_path="${REF_MASTER_INSTALLER_OVERLAY_DIR_PATH}"
...
sys_module_installer_file_install () {
...
mod_module_installer_file_install () {
...
##
### Tail: Model / mod_module_installer_file_install
################################################################################
